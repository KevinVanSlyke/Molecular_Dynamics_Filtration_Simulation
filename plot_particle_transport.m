function [varargout] = plot_particle_transport()
%Plots single simulation particle count passing through each of three pores
%   Crawls through simulation directories to read transmition data and plot
%   the positive/negative transport through each pore and filter layer
...
for i = 1 : 1 : 3
    pore = pores{1,i};
    try
        transport_data = read_particle_transport_data(pore);
