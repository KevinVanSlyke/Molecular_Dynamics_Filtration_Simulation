function [] = convertChunkFile(simString, nBinsX, nBinsY, particleType, dataType, trialIndex)
...
read_convert_chunk_file(simString, nBinsX, nBinsY, particleType, dataType, trialIndex);
