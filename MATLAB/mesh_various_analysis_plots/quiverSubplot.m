...
xtickangle(45);
yticks(yTicks);
ylabel("Vertical Displacement, $y/\sigma$ (Dimensionless)", 'Interpreter', 'LaTex', 'FontSize', 12 );
...
ax2.FontSize = 12;
axis square;
xlabel("Horizontal Displacement, $x/\sigma$ (Dimensionless)", 'Interpreter', 'LaTex', 'FontSize', 12 );
xtickangle(45);
yticks(yTicks);
yticklabels([]);
