function [outFlowAngleLabels,outFlowAngleData] = edge_particle_sums(simString,edgeCountA,edgeCountI,lowTheta,upTheta,centeredX,centeredY,sliceIndx,figDir,saveplots)
