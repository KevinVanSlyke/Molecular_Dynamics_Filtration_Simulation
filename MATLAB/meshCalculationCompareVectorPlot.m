...
%     ylabel("$y'~(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("CalcInternalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(totalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("TotalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(totalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("FlowKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(calcTotalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("CalcTotalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(totalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("DiffFlowInternalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(totalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("DiffFlowTotalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     hcolorBar = colorbar('Ticks',linspace(0,max(totalKE,[],'all'),8),'TickLabels', num2cell(0:0.5:3.5));
    ...
    ylabel("y $(r*)$",'Interpreter','Latex');
    view(0,90);
    print(strcat("DiffTotalInternalKE_Timestep_",num2str(t(i)*200)), '-dpng');
    close(qFig);
...
%     ylabel("y $(r*)$",'Interpreter','Latex');
%     view(0,90);
%     print(strcat("DiffCalcTotalKE_Timestep_",num2str(t(i)*200)), '-dpng');
%     close(qFig);
...
%     ylabel("y $(r*)$",'Interpreter','Latex');
%     view(0,90);
%     print(strcat("DiffInternalKE_Timestep_",num2str(t(i)*200)), '-dpng');
%     close(qFig);
...
%     ylabel("y $(r*)$",'Interpreter','Latex');
%     view(0,90);
%     print(strcat("LAMMPSInternalKE_Timestep_",num2str(t(i)*200)), '-dpng');
%     close(qFig);
end
