function [outFlowAngleLabels,sortedOutFlowAngleData] = ensemble_outflow_angle_count(ensembleDir, figDir, doPlot)
...
%         end
        ...
        [outFlowAngleLabels,outFlowAngleData(n,:)] = plot_edge_count_sums(rootList(i).name,argonEdgeCounts,impurityEdgeCounts,lowTheta,upTheta,centeredX,centeredY,sliceIndx,figDir,doPlot);
    end
    
end
sortedOutFlowAngleData = sortrows(outFlowAngleData,[2 6]); %Sort data series by D and S
end