...
for n = 1 : 1 : nFiles
    if endsWith(dataDirList(n).name(), '.mat') && ~startsWith(dataDirList(n).name(), 'Mesh')
...
if exist('uI','var') == 1
    ...
    save(strcat('Mesh_Data_', simString,'.mat'),'simString','x','y','t','uMeanA','vMeanA','tempMeanA','internalTempMeanA','countMeanA','uMeanI','vMeanI','tempMeanI','internalTempMeanI','countMeanI','uStdA','vStdA','tempStdA','internalTempStdA','countStdA','uStdI','vStdI','tempStdI','internalTempStdI','countStdI');
else
    save(strcat('Mesh_Data_', simString,'.mat'),'simString','x','y','t','uMeanA','vMeanA','tempMeanA','internalTempMeanA','countMeanA','uStdA','vStdA','tempStdA','internalTempStdA','countStdA');
%     save(strcat('Mesh_Data_', simString,'.mat'),'simString','x','y','t','uMeanA','vMeanA','tempMeanA','uStdA','vStdA','tempStdA');
end
end