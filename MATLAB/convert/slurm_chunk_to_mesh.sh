...
echo -e 'matlab -nodisplay -r "spmd_chunk_wrapper(${simString}, ${atomType}, $SLURM_NTASKS, ${trialIndex}, ${nBinsX}, ${nBinsY})"'
matlab -nodisplay -r "spmd_chunk_wrapper('${simString}', '${atomType}', '$SLURM_NTASKS', '${trialIndex}', '${nBinsX}', '${nBinsY}')"
