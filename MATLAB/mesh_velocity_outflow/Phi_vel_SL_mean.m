function [dataLabels, phiStatData] = Phi_vel_SL_mean(phiAValues, phiIValues, shift, dVal, tStart, tEnd)
...
phiStatData = [shift, dVal, meanAPhi, stdAPhi, meanIPhi, stdIPhi];
dataLabels = ["Registry Shift", "Impurity Diameter", "meanAPhi_SL1", "meanAPhi_SL2", "stdAPhi_SL1", "stdAPhi_SL2", "meanIPhi_SL1", "meanIPhi_SL2", "stdIPhi_SL1", "stdIPhi_SL2"];
